...
def main():
    ...
    parser.add_argument("--root", default=os.getenv("DATA_ROOT", "/Users/idanlipschitz/Projects/embedding model/archive"))
    parser.add_argument("--work_dir", default=os.getenv("WORK_DIR", "/Users/idanlipschitz/Projects/embedding model/archive/.work"))
    parser.add_argument("--images_dir", default=os.getenv("IMAGES_DIR", "/Users/idanlipschitz/Projects/embedding model/archive/images_cache"))
    parser.add_argument("--index_dir", default=os.getenv("INDEX_OUT_DIR", "/Users/idanlipschitz/Projects/embedding model/archive/vector_index"))
