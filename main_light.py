...
# Use lightweight embedding service for 512MB limit
from embedding_service_light import get_embedding_service

app = FastAPI(title="Modo Embedding Service (Light)")
...
def health():
  try:
    ...
    return {"status": "ok", "index_dir": svc.index_dir, "index_exists": ok, "service_type": "light"}
