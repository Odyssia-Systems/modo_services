...
# Allow override via env; default to repo-relative vector_index
META_PATH = os.getenv(
    "IMAGE_META_PATH",
    os.path.join(os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir)), "vector_index", "image_meta.json"),
)
